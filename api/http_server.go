...
func (s *HTTPServer) Handler() http.Handler {
	...
	mux.HandleFunc("/v1/cards:search", s.handleCardsSearch)
	mux.HandleFunc("/v1/cards:feedback", s.handleCardsFeedback)
	mux.HandleFunc("/v1/cards:bundle", s.handleCardsBundle)
	mux.HandleFunc("/v1/taskstate:export", s.handleTaskStateExport)
