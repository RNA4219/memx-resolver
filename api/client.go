...
type Client interface {
	...
	CardsSearch(ctx context.Context, req CardsSearchRequest) (CardsSearchResponse, *Error)
	CardFeedback(ctx context.Context, req CardFeedbackRequest) (CardFeedbackResponse, *Error)
	PromptBundle(ctx context.Context, req PromptBundleRequest) (PromptBundleResponse, *Error)
	TaskStateExport(ctx context.Context, req TaskStateExportRequest) (TaskStateExportResponse, *Error)
